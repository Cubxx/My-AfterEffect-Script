var cubx = function () {
    var a = {
        ...
        emptyArray: function (array) {
            var obj = {};
            var group_info_arr = array.map(function (e, i) {
    ...
    var b = {
        ...
        add_layer: (function (type) {
            ...
            var layer = (_b = (_a = b.get_active_comp().layers)['add' + type]) === null || _b === void 0 ? void 0 : _b.call(_a);
            if (layer === void 0) {
                a.abort('添加图层错误\t' + type);
            }
            return layer;
        ...
        add_layers_from_selected_groups: function () {
            ...
            var beDels = groups.map(function (e) { return (b.add_layer_from_group(e), e); });
            a.emptyArray(beDels);
        },
    ...
    var f = {
        read: function (file) {
            File.isEncodingAvailable('utf-8') || a.abort('读取文件失败: 系统不支持utf-8');
            file.encoding = 'utf-8';
            file.open('r');
            var text = file.read();
            file.close();
        ...
        write: function (file, text) {
            File.isEncodingAvailable('utf-8') || a.abort('写入文件失败: 系统不支持utf-8');
            file.encoding = 'utf-8';
            file.open('w');
            file.write(text);
            file.close();
    ...
    (function () {
        ...
        Object.prototype.is = function (constructor) {
            if (this instanceof constructor) {
                ...
                a.abort("\u6570\u636E\u7C7B\u578B\u4E0D\u4E3A ".concat(constructor));
            }
        };
